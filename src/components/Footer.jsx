        ...
        <div className="container">
          <div className="row address-main">
            <div className="col-lg-4 col-sm-12 col-xs-12">
              <div className="address-box clearfix">
                <div className="add-icon">
                  <img src={Image1} alt="Office Location Icon" />
                </div>
                <div className="add-content">
                  <h5>Adress</h5>
                  <p>Torshamngatan 35, 164 40 Kista</p>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-sm-12 col-xs-12">
            ...
            <div className="col-lg-4 col-sm-12 col-xs-12">
              <div className="address-box clearfix">
                <div className="add-icon">
                  <img src={Image3} alt="Email Icon" />
                </div>
                <div className="add-content">
                  <h5>Email</h5>
                  <p>
                    <a href="mailto:info@meone.se" style={{ textDecoration: 'none' }}>
                      info@meone.se
                    </a>
                  </p>
                </div>
